...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
		...
		topMargin.constant = Ruler.universalVertical(0, 20, 40, 60, 80, 100, 120).value
        ...
        let universalHeight = Ruler.universalVertical(5, 10, 20, 30, 40, 60, 70).value
        ...
        colorView.backgroundColor = Ruler.universalVertical(UIColor.black, UIColor.red, UIColor.blue, UIColor.green, UIColor.yellow, UIColor.purple, UIColor.green).value
